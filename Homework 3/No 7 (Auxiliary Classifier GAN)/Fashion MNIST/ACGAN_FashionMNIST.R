...
save(generator, file = "D:/David/Fashion MNIST/ACGAN_FashionMNIST_model_generator.rda")
save(discriminator, file = "D:/David/Fashion MNIST/ACGAN_FashionMNIST_model_discriminator.rda")

saveRDS(generator, file = "D:/David/Fashion MNIST/ACGAN_FashionMNIST_model_generator (saveRDS).rda")
saveRDS(discriminator, file = "D:/David/Fashion MNIST/ACGAN_FashionMNIST_model_discriminator (saveRDS).rda")